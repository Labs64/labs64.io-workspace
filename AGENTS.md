...
| Authorization policy (Cerbos PDP) | Change OAuth `security` and `x-labs64.auth` in the module OpenAPI; policies are generated by `labs64.io-helm-charts/policies/build-authz-policies.sh` into `charts/authz-pdp/` |
