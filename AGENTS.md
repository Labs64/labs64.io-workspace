...
| Authorization policy (Cerbos PDP) | Change `x-labs64-auth` in the module OpenAPI; policies are generated by `labs64.io-helm-charts/policies/build-cerbos-policies.sh` into `charts/cerbos/` |
